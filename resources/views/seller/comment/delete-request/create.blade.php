...
@section('content')
    ...
    <div class="col-md-7 offset-md-2 col-lg-6 offset-lg-3 py-8 text-md-start text-center">
        <div class="mb-2">
            <h3 class="text-center">درخواست حذف نظر</h3>
            ...
            <div class="card-body">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <form action="{{ route('seller.comment-delete-request.store', $comment) }}" method="POST" class="row gx-2 gy-2 align-items-center">
                            ...
                            <div class="input-group-icon mb-2">
                                <div class="row mb-3">
                                    <label class="col-sm-3 col-form-label" for="body">علت درخواست حذف</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control input-box form-foodwagon-control" id="body" name="body">{{ old('body') }}</textarea>
                                        @error('body')
