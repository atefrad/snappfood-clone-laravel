        ...
        <div class="card-body">
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <form action="{{ route('seller.food.update', $food) }}" method="POST" enctype="multipart/form-data" class="row gx-2 gy-2 align-items-center">
                        ...
                        <div class="input-group-icon mb-2">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-box form-foodwagon-control" name="name" id="name" type="text" placeholder="نام" value="{{ old('name', $food->name) }}" />
                                    @error('name')
...
{{--                                        <option value="" selected disabled>لطفا دسته بندی غذا را انتخاب نمایید.</option>--}}
                                        @foreach($foodCategories as $foodCategory)
                                            <option value="{{ $foodCategory->id }}"  @if(in_array($foodCategory->id, old('food_category_id', $food->foodCategories->pluck('id')->toArray()))) selected @endif>{{ $foodCategory->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="input-group-icon mb-2">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-box form-foodwagon-control" name="ingredient" id="ingredient" type="text" placeholder="مواد اولیه" value="{{ old('ingredient', $food->ingredient) }}" />
                                    @error('ingredient')
                                    <span class="text-red ms-2 fs--1">
                                    {{ $message }}
                                    </span>
                        ...
                        <div class="input-group-icon mb-2">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-box form-foodwagon-control" name="price" id="price" type="text" placeholder="قیمت" value="{{ old('price', $food->price) }}"/>
                                    @error('price')
                                    <span class="text-red ms-2 fs--1">
                                {{ $message }}
                                </span>
                        ...
                        <div class="input-group-icon mb-2">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @if($food->image !== null)
                                        <img class="my-3" src="{{ asset($food->image) }}" alt="" width="100" height="70">
                                    @endif
                                    @error('image')
                                    <span class="text-red ms-2 fs--1">
                                    {{ $message }}
