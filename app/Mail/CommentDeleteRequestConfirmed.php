...
class CommentDeleteRequestConfirmed extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Comment Delete Request Confirmed',
        );
    }
    ...
    {
        return new Content(
            markdown: 'mail.comment.delete-request.confirmed',
            with: [
